...
export const Urls = {
  ...
  HooliganHymnalServer: "https://mcb-hymnal-server.herokuapp.com",
  // dev/beta server
  //HooliganHymnalServer: 'https://mcb-hymnal-dev.herokuapp.com',

  // Social media and websites
  Twitter: "https://twitter.com/MCBrigade14",
  Facebook: "https://www.facebook.com/magiccitybrigade",
  Instagram: "https://www.instagram.com/mcbrigade14",
  Website: "https://www.magiccitybrigade.org/",
...
export const DefaultColors = {
  ...
  ButtonBackground: Palette.Gold,
  ButtonText: Palette.White,
  HeaderBackground: Palette.Black,
  HeaderText: Palette.White,
  BlackText: Palette.Black,
  ColorText: Palette.Gold,
  Primary: Palette.Black,
  Secondary: Palette.HammerRed,
};
