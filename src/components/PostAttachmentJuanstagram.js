...
export default class PostAttachmentJuanstagram extends React.Component {
  ...
  render() {
    ...
    let juanstagramPost = {
      ...
      likes: "423",
      caption:
        "Post not found, type: " + JSON.stringify(this.props.juanstagramPost),
      comments: [],
    };
    ...
    let caption =
      "*" + juanstagramPost.account + "* " + juanstagramPost.caption;
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.commentsContainer}>{commentsDisplay}</View>
      </View>
    );
  }
}
