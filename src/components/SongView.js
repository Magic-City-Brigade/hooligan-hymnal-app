  ...
  render() {
    ...
    if (song.referenceTitle)
      referenceDisplay = (
        <ItalicText
          ...
          onLongPress={this._onLongPressReference}
        >
          {song.referenceTitle}
        </ItalicText>
      );
    ...
    return (
      <View style={styles.container}>
        <View
          style={{ paddingBottom: 1, flexDirection: i18n.getFlexDirection() }}
        >
          <View style={{ flex: 1, backgroundColor: DefaultColors.Background }}>
            <BoldText style={styles.title} onLongPress={this._onLongPressTitle}>
              {song.title}
            </BoldText>
            {referenceDisplay}
          </View>
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          <View style={{ flex: 1 }}>
            <ItalicText style={styles.instructions}>
              {song.instructions}
            </ItalicText>
            <ParsedText
              parse={[
