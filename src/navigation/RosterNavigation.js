...
const FoesNavigation = (props) => {
  return (
    <FoesStack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <FoesStack.Screen
        name="FoePlayers"
        component={Screens.RosterFoePlayers}
      />
    </FoesStack.Navigator>
  );
};
            ...
            return (
              <View style={styles.tabContainer}>
                <MaterialCommunityIcons
                  name={Skin.Roster_FriendsTabIcon}
                  color={color}
                  size={23}
                  style={styles.tabIcon}
                />
                <MediumText
                  style={{ color: color, fontSize: FontSizes.normalButton }}
                >
                  {i18n.t("screens.rostertabs.friends")}
                </MediumText>
              </View>
            );
          },
            ...
            return (
              <View style={styles.tabContainer}>
                ...
                <MediumText
                  style={{ color: color, fontSize: FontSizes.normalButton }}
                >
                  {i18n.t("screens.rostertabs.foes")}
                </MediumText>
              </View>
            );
          },
