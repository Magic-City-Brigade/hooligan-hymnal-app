...
class PostAttach extends React.Component {
    ...
    return (
      <ScrollView style={{ flex: 1 }}>
        <BoldText style={{ textAlign: "center" }}>
          {i18n.t("screens.postattach.attachmenttypes")}
        </BoldText>

        <BigButton
          label={i18n.t("screens.postattach.selectplayer")}
          iconName="account"
          onPress={() => {
        ...
        />
        <BigButton
          label={i18n.t("screens.postattach.selectsong")}
          iconName="music"
          onPress={() => {
        ...
        />
        <BigButton
          label={i18n.t("screens.postattach.composesong")}
          iconName="microphone"
          onPress={() => {
        ...
        {Settings.PostAttach_ShowGKNickname && (
          <BigButton
            label={i18n.t("screens.postattach.gknickname")}
            iconName="hand"
            onPress={() => {
              this.props.navigation.navigate(
        ...
        <BigButton
          label={i18n.t("screens.postattach.prideraisermatch")}
          iconName="chart-line"
          onPress={() => {
            this.props.navigation.navigate(
        ...
        <BigButton
          disabled={true}
          label="Link to App Songbook"
          iconName={Skin.Icon_Songbook}
          buttonStyle={{ backgroundColor: "gray" }}
        />
        <BigButton
          disabled={true}
          label="Link to App Roster"
  ...
  onAttachmentComplete = (data) => {
    if (this.onAttachmentComplete) this.onAttachmentComplete(data);
  };
}
