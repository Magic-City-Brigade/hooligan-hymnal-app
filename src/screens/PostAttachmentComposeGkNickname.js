...
class PostAttachmentComposeGkNickname extends React.Component {
  ...
  setData = () => {
    ...
    let colorData = [];
    this.props.globalData.state.htmlColors.colorFamilies.forEach(
      (colorFamilyChild) => {
        let colorList = [];
    ...
    return (
      <View style={{ flex: 1, paddingBottom: 10 }}>
        <BoldText style={{ textAlign: "center" }}>
          {i18n.t("screens.postattachmentcomposegknickname.gknickname")}
        </BoldText>
        <MediumText style={styles.instructions}>
          {i18n.t("screens.postattachmentcomposegknickname.instructions1")}
        </MediumText>
        <TextInput
        ...
        />
        <MediumText style={styles.instructions}>
          {i18n.t("screens.postattachmentcomposegknickname.instructions2")}
        </MediumText>
        <SectionList
        ...
        />
        <MediumText style={[styles.instructions, { paddingTop: 8 }]}>
          {i18n.t("screens.postattachmentcomposegknickname.instructions3")}
        </MediumText>
        <BigButton
          buttonStyle={{
...
export default withUnstated(PostAttachmentComposeGkNickname, {
